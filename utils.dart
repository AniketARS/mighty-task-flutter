...
ThemeData mainAppData = ThemeData(
  primaryColor: Color.fromRGBO(65, 87, 223, 1),
  textTheme: TextTheme(
    headline1: TextStyle(
...
class Date {
  ...
  Date({this.day, this.month, this.ofCurrentMonth});

  @override
  String toString() {
    super.toString();
    String representation = '';
    representation += '${monthNames[this.month - 1]}';
    representation +=
...
List<Participant> participants = [
  ...
  Participant('assets/images/6.jpg'),
];
